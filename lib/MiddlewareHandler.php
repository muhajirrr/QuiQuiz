 ...
 * @link https://github.com/esbenp/onion
 * @license https://github.com/esbenp/onion/blob/master/LICENSE
 */
...
class MiddlewareHandler {
    ...
    {
        if ($layers instanceof MiddlewareHandler) {
